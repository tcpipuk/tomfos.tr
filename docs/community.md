...
# Tom's Matrix Community - Community Guidelines

These guidelines primarily apply to the Matrix space
[#space:tomfos.tr](https://matrix.to/#/#space:tomfos.tr) and all related rooms. It may also be used
by other Matrix rooms as appropriate.

This community aims to be welcoming and constructive for everyone. As the administrator and moderator,
I maintain these spaces on a best-endeavours basis. This means I'll try my best to be fair and see
all sides of an issue, but as this is volunteer-run, I may need to make moderation decisions quickly.
...
The goal is to maintain spaces where people can collaborate and discuss topics constructively.
Moderation decisions are made with this goal in mind, not to enforce arbitrary rules. I aim to be
reasonable, but my primary responsibility is to the health of the community as a whole.

---
These community guidelines may be updated periodically. Last update:
